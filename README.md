...
We log all of this including the users iam name to the systems secure syslog which can then be forwarded to any audit log you wish cloudwatch or other.
...
Ensure the script has the following permisions:

```
owner=root group=root mode=0755
```

Ensure the following varible is set correctly in the script for your systmes syslog
```
